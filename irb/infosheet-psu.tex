...
%, your TA/course instructor will use Landslide to debug your submitted projects, and you will receive these debugging reports either before or after the project deadline, depending on the project.
...
%the debugging reports, snapshots of your code at the time the bug was found, and
...
%When we run Landslide on your code, we will record the same bug reports we distribute to you, as well as snapshots of your code at the time the bug was found.
...
% PSU wants this gone!
%PSU IRB website: {\tt https://www.research.psu.edu/irb}. Email: {\tt irb-orp@psu.edu}.
...
\begin{itemize}
	...
	% PSU wants this gone!
	%\item {\bf Timothy Zhu} (Course Instructor): Email: {\tt timothyz@cse.psu.edu}; Office: W353 Westgate Building
\end{itemize}
