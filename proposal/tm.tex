...
\begin{itemize}
	...
	\item To what degree can DPOR reduce these programs' state spaces? Assuming I achieve the reduction challenge (Section \ref{sec:tm-reduction-challenge}), how much benefit is conferred, and how commonly across different types of programs?
\end{itemize}
