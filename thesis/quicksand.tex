...
I will discuss the trade-off inherent in number of preemption points used (\cref{sec:quicksand-pps}),
...
Later, \cref{sec:landslide-dpor} showed DPOR prune 16 of those as equivalent,
...
\subsection{Types of preemption points} % TODO: find better name for sec'n
...
% TODO: add section refs to this para
...
\begin{itemize}
	...
	\item {\bf Data race} refers to the racing access pair itself (\cref{sec:landslide-datarace}).
		% TODO: scan this chapter for consistency of dis
