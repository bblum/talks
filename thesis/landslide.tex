...
\begin{itemize}
	...
	\item (If during the student user study,) compresses the resulting log files,
		...
		\revisionminor{(see \sect{\ref{sec:education-pebbles-instrumentation}})}.
\end{itemize}
...
\revisionminor{(\sect{\ref{sec:tell-landslide}})}
is not necessary,
...
\revision{\sect{\ref{sec:future-friendly}} discusses how these bug reports might be further improved
...
\revisionminor{Landslide} also invokes the data race analysis (\sect{\ref{sec:landslide-datarace}}).
