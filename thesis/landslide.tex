...
% TODO: mb this should be a section, not a subsection, bc there are too many subsubsubsections herein?
...
Following are the non-self-explanatory options.
\begin{itemize}
...
{\bf Optional but strongly recommended annotations}
