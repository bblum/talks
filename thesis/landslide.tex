...
After the explorer picks a past point of program preemption, % sorry this started out like that and i just had to roll with it
...
why it's ok is documented in an {\tt XXX} comment.}
