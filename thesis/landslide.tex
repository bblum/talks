...
The overhead of this check is linear time in the number of retries permitted,
although this is typically negligible compared to the exponential size of state spaces overall.
