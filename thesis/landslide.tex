...
in html format, recommended to be viewed in a web browser.
...
An example bug report is shown in Figure~\ref{fig:bugreport}.

In addition to the preemption trace, the bug report reports some additional helpful information:
...
The intrepid source-diver may find all such cases of extra bug details by searching for the macro {\tt FOUND\_A\_BUG\_HTML\_INFO} in Landslide's code.}
