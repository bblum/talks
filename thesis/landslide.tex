...
This serves as a ``progress bar'' that represents the estimated overall progress \cite{progress-bar},
approaching 1 (not necessarily monotonically) as exploration continues.
...
in which case they would have to be recomputed,
...
\subsubsection{Accuracy example}
...
only now WBE's prediction is accurate at A but overestimates at B and C,
