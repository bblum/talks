...
\begin{itemize}
	...
	\item {\tt -M}: enable Maximal State Space mode,
		...
		% TODO: more speicfic sectio nreference
...
Prior work \cite{dpor,optimal-dpor} refers to the set of these $I_{ij}$s,
for a given $i$,
...
This corresponds to the {\em sleep sets} optimization described by prior work \cite{dpor,optimal-dpor},
