...
Many of the P2 test cases can be seen to invoke the {\tt misbehave()} system call
...
is a closely-guarded secret among 15-410 course staff.
...
Hypothetically speaking, a reader with access to the top-secret Pebbles source code
