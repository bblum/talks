...
the participation rate rose to NN\% % TODO
(XX out of YY P2-submitting groups across ZZ semesters (TODO actually count them but obviously it will be higher)). % TODO
This alone could be seen as a major step in mitigating said selection bias.
...
I cannot think of any reason gender, racial, or other demographic-based bias might affect this study.
In fact, according to my memory alone, the proportion of women among students
attending the Landslide clinics (\sect{\ref{sec:education-pebbles-recruiting}})
was considerably higher than the class's overall gender ratio,
although I did not record any such statistics scientifically.
