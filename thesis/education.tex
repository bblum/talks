...
\begin{table}[h]
	\begin{center}
		...
		\begin{tabular}{r|crcrc|r}
			...
			% TODO when you adjust this, adjust the % of participance down in the discussion para
			PSU S'18	& &  38	& &  98	& & 136 \\
			\hline
...
on account of the possibility some students may have truly fixed them but skipped the verification step thereafter.
...
\begin{enumerate}
	...
	\item {\em For each bug Landslide found in your code, how trivial or severe do you feel it was?}
		...
		on a spectrum between annoying style checker or a life-saver,
