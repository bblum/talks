...
and provides diagnostic output that helps the student to understand and solve them.
...
and returned its preemption traces to any study volunteers.
...
We decided on this procedure to optimize for most benefit to the students rather than for scientific rigor,
due to the small sample size (4 volunteering student groups among 21 submitted projects).
...
% cmu - fps marked in the reuslts files? is this gonna be an accurate count?
...
which would be a potential heap corruption bug,
