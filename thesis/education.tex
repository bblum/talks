...
% TODO: contingency table for drop rate? but.... need to get studence names to make sure they didn't just solbo, or w/e
...
% idk about this
%Though ``P3 grading criteria results in a tighter bell curve than P2'' is another potential hypothesis,
% let me have this exclamation mark. please
...
To address this doubt,
I simulated who among the buggy {\tt thr\_exit()} implementations
would have found and fixed the bug
given a heap-checking unit test
by checking whether Landslide finds their bug ``deterministically''
% TODO - more specific section reference - quicksand det/nondet drpps eval
(i.e., on the first interleaving, similarly to \sect{\ref{sec:quicksand-eval}}).
So doing,
the 11-10-0-16 distribution becomes
NN-MM-PP-QQ, % TODO
with a new $p$ value of
0.ppp, % TODO
%% which one, will it be??? :-O
% still a significant difference.
% still positively correlated, but no longer significant.
whose significance is a MYSTERYYYY.
...
Modest immediate improvement in students' project grades was observed,
...
Table~\ref{tab:TODO} % TODO -- make a table or graph showing correlation between bugfinding and who responded on the survey
...
% could studence who didn't find bugs also have had a good experience? (think of how...)
