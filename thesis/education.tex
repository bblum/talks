...
are one of 15-410 staff's closely-guarded secrets (see \sect{\ref{sec:410-secrecy}}).
Suffice it to say that the test {\tt paraguay} invokes a specially-made Pathos {\tt misbehave} mode
