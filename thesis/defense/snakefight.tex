...
\begin{document}
\renewcommand{\inserttotalframenumber}{67}
\normalem
\begin{frame}
	\titlepage
\end{frame}
...
\begin{frame}{Thesis Statement}
	The Quicksand algorithm %combines theory and heuristics to
...
\end{frame}
\begin{frame}{Outline}
	\hilight{gray}{The Quicksand algorithm %combines theory and heuristics to
	practically debugs and verifies many exponential state spaces.} \\
...
\begin{frame}{Conclusion}
	...
	\begin{itemize}
		...
		\item Student yield-loop blocking % student (adj). from "studence"
