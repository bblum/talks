...
% % nwf made this but i don't know how to get it to work?
% \usepackage{etoolbox}
% \makeatletter
% \apptocmd{\ref}{%
%   \immediate\write\@auxout%
%     {\expandafter\string\csname nwf@backref\endcsname{#1}{\arabic{page}}}%
% }{}{}
%
% \newcommand{\nwf@backref}[2]{%
%   \ifcsdef{nwf@backrefs@#1}%
%    {\csgappto{nwf@backrefs@#1}{, #2}}%
%    {\csgdef{nwf@backrefs@#1}{#2}}%
% }
% \AtEndDocument{\let\nwf@backref\relax}
%
% \newcommand{\linksto}[1]{\csname nwf@backrefs@#1\endcsname}
% \makeatother
...
Even as I built Landslide by myself,
implementation is of course barely the first step of scientific contribution.
I would honor here the many people who supported me during these 7 years and made this thesis possible.
...
provided unending guidance on education, writing, life, you name it,
...
and supplied constant enthusiasm and reassurance that Landslide was a boon to 15-410 that kept me going.
I can't express the depth of my gratitude to Dave strongly enough,
even though three of the Landslide-friendly tests never made it upstream into the official P2 test suite.

% jiri,
% .. orient me in the world of research ..

% these 3 names ar ethe ones without which the thesis flat out could not have happened
...
David Blum and Skye Toor provided invaluable advice on statistical analysis
that helped me evaluate the student grade distributions therein.
Mario Dehesa-Azuara generously contributed the transactional memory data structures
...
or perhaps would have grown too frustrated for lack of a cathartic outlet for conference paper woes.
...
% [ ] 410 ta community
% [ ] emarhavil
% [ ] pdl consortium industry ppl who offered good advices
% [ ] anyone who ever said how cool it was that i helped students for my research
% [ ] adam and co. for GPI, if you feel like it
...
that I hope will well outlive the card game that brought us together.
...
% (literally and figuratively for each side of the analogy, respectively)
...
% TODO: Get a little bit preachy about how computer programs should be created to help humans,
% not to look as much like scifi as possible, by knowing their limits, asking for help when they get confused, etc.
