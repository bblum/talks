...
\begin{itemize}
	\item In \Cref{chap:quicksand},
		...
		to effectively balance formal verification with heuristic bug-finding speed
	...
	\item In \Cref{chap:education},
		the behind-the-scenes yield-loop blocking algorithm
		(itself admittedly heuristic)
		allowed Landslide to automatically instrument all student implementations
		...
		a very small fraction of all the world's programmers,
		let alone all those in higher education,
	...
	\item In \Cref{chap:tm},
		...
		and the heuristic use of abort code reduction and abstraction reduction
...
human and program may cooperate to debug and verify even more complex software than ever before.}
