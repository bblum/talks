...
that concurrency bugs are notoriously difficult to find, reproduce, diagnose, and fix
% ,
...
% TODO start up again on page 161 (AVIO: Detecting atomicity violations via access interleaving invariants.)
}.
