...
% dejafu A Concurrency Testing Library for Haskell (2016 ver.)
% parrot?
% TODO more
...
Chapter~\ref{chap:landslide} provides source code links and serves as a guide to browsing the repository.
