...
Since then, I have extended it with a wide array of features and algorithms,
...
and compensates for them with heuristics informed by user's own human intuition.
...
\begin{enumerate}
	...
	\item {\bf Educational use (\Cref{chap:education}).}
		...
		which has recently adopted CMU's thread library project,}
		to provide
