...
\begin{figure}[p]
	...
	\caption[Visualization of interleaving state space for the program in Figure~\ref{fig:concurrency-bug}.]
		{Visualization of interleaving state space for the program in Figure~\ref{fig:concurrency-bug}.
...
\begin{enumerate}
	...
	\item \revision{{\bf Relaxed memory.}
		...
		For further discussion see \sect{\ref{sec:quicksand-discussion}} and \sect{\ref{sec:tm-warpzone-relaxed}}.}
	\item {\bf Schedule.}
