...
The example TSX program from \Cref{fig:htm-example} (\cref{sec:overview-tm})
...
\begin{figure}[t]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption[Impossible hypothetical interleaving within transactions of \Cref{fig:htm-example-reproduced}.]
		{Impossible hypothetical interleaving within transactions of \Cref{fig:htm-example-reproduced}.
...
\begin{proof}
	...
	satisfying case 1.
	Otherwise, by DPOR's definition of transition dependence (\cite{dpor}, \cref{sec:landslide-dpor-hb}),
