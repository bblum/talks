...
Landslide's scheduler sets the ``in transaction'' action flag for that thread (\sect{\ref{sec:landslide-scheduler}}),
...
it is considered not a data race if not both threads' ``in transaction'' flags were set in addition to the usual conditions;
