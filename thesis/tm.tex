...
\begin{table}[p]
	\begin{center}
		...
		\begin{tabular}{cc||r|r||r|r||r|r}
			...
			% stm ok, rts ok, baseline alone needs redo
			& 3,2 & \cpu{2492.17}	& \ints{60606}	& \cpu{2363.41}	& \ints{44862}	& \cpu{639.62}	& \ints{14304} \\
			% TODO: everything above this line needs rerun
			% TODO: everything below is fine up to dpor-preferred & thr_bottom1 updates
			\multicolumn{8}{c}{everything above this line needs rerun for dpor-preferred tid + thr\_bottom1} \\
	...
	\caption{Transactional tests verified (or not) by Landslide.
		...
		{\em Thesis draft note: Some of these tests still need to be rerun on account of landslide implementation updates
		to ensure consistent cpu times with the next table,
