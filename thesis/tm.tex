...
\revisionminor{as shown below in Figure~\ref{fig:htm-example-assemblified}.}
...
\begin{figure}[h]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Figure~\ref{fig:htm-example-reproduced} with non-atomic operations shown as pseudo-assembly.}
...
\begin{figure}[t]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption[Impossible hypothetical interleaving within transactions of Figure~\ref{fig:htm-example-reproduced}.]
		{Impossible hypothetical interleaving within transactions of Figure~\ref{fig:htm-example-reproduced}.
...
So, a hypothetical interleaving such as shown in Figure~\ref{fig:htm-example-interleaving},
...
\begin{figure}[h]
	...
	\caption[Variant of the program in Figure~\ref{fig:htm-example-reproduced}.]
		{Variant of the program in Figure~\ref{fig:htm-example-reproduced},
...
\begin{itemize}
	\item {\tt -X} (for ``tsX'' or ``Xbegin'') enables the basic features:
		...
		(\revisionminor{\sect{\ref{sec:tm-design-failure}}}, \sect{\ref{sec:txn-failure}}),
...
\begin{table}[t]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption[Continuation of Table~\ref{tab:tm-verifs}, demonstrating abstraction reduction.]
		{Continuation of Table~\ref{tab:tm-verifs},
