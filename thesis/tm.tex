...
interleaves while a first abort set is already being tracked).

% TODO

% TODO - rewrite the following example so that it only uses retry aborts
...
\begin{table}[h]
	\begin{center}
		...
		\begin{tabular}{cc||r|r}
			...
			& 3,1 & \cpu{218.02} & \ints{185} \\ % certified causality ok
