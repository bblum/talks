...
still state their theorems and proofs in prose \cite{bpor,optimal-dpor,tsopso,satcheck,mcr,quicksand},
so this section's proofs will regrettably do likewise,
leaving the rigor of mechanization to future work.
The reader may at least draw assurance from the existing formal verifications of
the transactional semantics required herein.
...
Even so, I must also leave a soundness proof for this optimization to future work.
While
%the basic idea is
...
nevertheless, this falls well short of formal proof.
